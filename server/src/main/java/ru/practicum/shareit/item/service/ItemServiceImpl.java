...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto createItem(ItemDto itemDto, Long userId) {
        ...
        if (itemDto.getRequestId() != null) {
            itemRequest = requestRepository.findById(itemDto.getRequestId()).orElseThrow(() -> new NotFoundException("Запрос не найден"));
        }
    ...
    public CommentDto addComment(Long itemId, Long userId, String text) {
        ...
        Comment comment = CommentMapper.toComment(text, user, item);
